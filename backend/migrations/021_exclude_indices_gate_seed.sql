...
-- value_type = 'boolean'  (1.0 = ON, 0.0 = OFF)
-- Default value 1.0 = filter ON (index ETF options suppressed by default).
...
INSERT INTO gate_configs (gate_name, tier, value, value_type, min_value, max_value, description)
VALUES
  (
