-- migration 020: RLS policies for tier_thresholds
-- Renamed from 012_tier_thresholds_rls.sql to avoid numbering collision
-- with 012_options_chain_cache.sql (fix: ING-S10 issue tracker).
